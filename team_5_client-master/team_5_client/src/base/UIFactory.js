...
gv.commonButton = function(w, h, x, y, text){
    if(text === undefined)
        text = "";
    var btn = new ccui.Button(res.base.img_normalBtn, res.base.img_pressedBtn, res.base.img_normalBtn);
    if(x === undefined)
        x = 0;
    if(y === undefined)
        y = 0;
    ...
    btn.setTitleColor(cc.color(72,34,22,255));
    ...
    var capInsets = cc.rect(10,10, 10, 10);
